...
class Repository:
    ...
    def __init__(self, name: str, full_name: str, url: str):
        self.name = name
...
class Reference:
    ...
    def __init__(self, ref: str, sha: str):
        self.ref = ref
        self.sha = sha
...
class GitHubService:
    ...
    def __init__(self, token: str, org: str | None = None):
        ...
        logger.info(f"Initialized GitHub service for {'org' if org else 'user'}: {org or 'personal'}")
