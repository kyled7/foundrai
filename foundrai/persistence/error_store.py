...
class ErrorStore:
    ...
    def classify_error(exception: Exception) -> str:
        ...
        if "rate" in msg or "rate_limit" in msg or "429" in msg:
            return "rate_limit"
        if "context" in msg or "token" in msg and ("limit" in msg or "overflow" in msg or "exceed" in msg):
            return "context_overflow"
        if "timeout" in msg or "timed out" in msg or exc_type in ("timeouterror", "asynciotimeouterror"):
            return "timeout"
